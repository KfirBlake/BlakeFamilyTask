...
export default function ChildTopBar() {
    ...
    return (
        <header className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100 shadow-sm transition-all md:px-8">
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-lg md:text-xl font-black text-gray-900 leading-tight">{profile.full_name}</span>
                </div>
            </div>
